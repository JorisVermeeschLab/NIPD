...
snpM2 <- args[11]
snphap <- args[12]
bornresolvedpat <- args[13]
bornresolvedmat <- args[14] #GC068910_ATCCTGTA.mat.resolved.2.hap
diseaseStart <- args[15]
diseaseEnd <- args[16]
gene <- args[17]
figdir <- args[18]
...
comp3 <- function(patfh, matfh, patres, matres, samplename, ffest_scale, chrom, snpP1, snpP2, snpM1, snpM2, snphap, bornresolvedpat, bornresolvedmat, diseaseStart, diseaseEnd, gene, figdir) {
    ...
    fo <- paste0(figdir, samplename, ".", chrom, ".diseaselocus.comp3.manu.pdf")
    pdf(file=fo, width=6, height=4.5)
    

    gtrellis_layout(n_track = 18, category=chrom, xaxis = FALSE, track_axis = c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, FALSE), border=FALSE, padding = unit(c(2, 2, 4, 2), "mm"), track_ylim = c(0, 1, 0, 1, 0, 1, 0, 0.8, 0, 0.8, 0, 1, 0, 1, 0, 0.8, 0, 1, 0, 1, 0, 1, 0, 0.8, 0, 1, 0, 1, -ffest_scale_fit, ffest_scale_fit, 0, 1, -ffest_scale_fit, ffest_scale_fit, 0, 1), track_height = unit.c(unit(0.5, "null"), unit(0.5, "null"), unit(0.3, "null"), unit(0.4, "null"), unit(0.3, "null"), unit(0.5, "null"), unit(0.3, "null"), unit(0.3, "null"), unit(0.3, "null"), unit(0.5, "null"), unit(0.3, "null"), unit(0.3, "null"), unit(0.3, "null"), unit(0.5, "null"), unit(2.5, "null"), unit(0.3, "null"), unit(2.5, "null"), unit(0.3, "null")), track_ylab = c("", "", "", "", "", "", "", "", "", "", "", "", "", "", "Pat.FAR.seg (%)", "", "Mat.FAR.seg (%)", ""), axis_label_fontsize = 6, lab_fontsize = 7, name_fontsize = 9, title=NULL, title_fontsize = 10, xlab=NULL)
    ...
    #6
    add_track(panel_fun = function(gr) {
	grid.text(c("Born child"), gp=gpar(fontsize=9))
	grid.lines(unit(c(diseaseStart, diseaseStart), "native"), unit(c(0, 1), "npc"), gp = gpar(col="#efb509", lty=2, lwd=1.2))
	grid.lines(unit(c(diseaseEnd, diseaseEnd), "native"), unit(c(0, 1), "npc"), gp = gpar(col="#efb509", lty=2, lwd=1.2))
    })
    #7
...
comp3(patfh, matfh, patres, matres, samplename, ffest_scale, chrom, snpP1, snpP2, snpM1, snpM2, snphap, bornresolvedpat, bornresolvedmat, diseaseStart, diseaseEnd, gene, figdir)
