...
plotdiseaselocus <- function(patfh, matfh, patres, matres, samplename, ffest_scale, chrom, diseaseStart, diseaseEnd, gene, figdir) {
    ...
    fo <- paste0(figdir, samplename, ".", chrom, ".diseaselocus.pdf")
    pdf(file=fo, width=8, height=5)
    

    gtrellis_layout(n_track = 10, category=chrom, xaxis = FALSE, track_axis = c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, FALSE), border=FALSE, padding = unit(c(2, 2, 4, 2), "mm"), track_ylim = c(0, 1, 0, 1, 0, 1, 0, 0.5, 0, 0.5, 0, 1, -ffest_scale_fit, ffest_scale_fit, 0, 1, -ffest_scale_fit, ffest_scale_fit, 0, 1), track_height = unit.c(unit(0.5, "null"), unit(0.5, "null"), unit(0.3, "null"), unit(0.4, "null"), unit(0.3, "null"), unit(0.5, "null"), unit(2.5, "null"), unit(0.3, "null"), unit(2.5, "null"), unit(0.3, "null")), track_ylab = c("", "", "", "", "", "", "Pat.FAR.seg (%)", "", "Mat.FAR.seg (%)", ""), axis_label_fontsize = 6, lab_fontsize = 7, name_fontsize = 9, title=NULL, title_fontsize = 11, xlab=NULL)
...
plotdiseaselocus(patfh, matfh, patres, matres, samplename, ffest_scale, chrom, diseaseStart, diseaseEnd, gene, figdir)
